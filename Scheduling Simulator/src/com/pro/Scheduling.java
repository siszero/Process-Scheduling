...
public abstract class Scheduling {
   ...
   protected Process[] processor = new Process[4];
   protected ArrayList<Process> pcs = new ArrayList<Process>();    // 모든 프로세스가 저장되어있는 큐
   protected LinkedList<Process> waitQ = new LinkedList<Process>(); // 도착한 프로세스가 대기하는 큐
